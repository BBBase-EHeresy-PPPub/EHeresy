...
| 6 | **Wrathful:** The controlling player chooses one of the Titan's weapons that has not been disabled and attacks with it, using a Ballistic Skill and Weapon Skill of 4+, following the standard Combat Sequence (see page 33 of the *Adeptus Titanicus* rulebook). |
